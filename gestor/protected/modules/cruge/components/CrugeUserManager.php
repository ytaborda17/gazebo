...
class CrugeUserManager
{
    ...
    */
    public function getLabelField(ICrugeField $field, $class="")
    {
    ...
    */
    public function getInputField($model, ICrugeField $field, $opt=array())
    {
        ...
        if (!empty($opt)) {
            $htmlOpt = array_merge($htmlOpt,$opt);
        }
        // caso listas: Listbox
