...
<div class='crugepanel user-assignments-role-list'>
	...
	<p style="margin-bottom:10px;"><?php echo ucfirst(CrugeTranslator::t("Haz click en un rol para ver los usuarios asignados a el"));?></p>
	<ul class='auth-item'>
	<?php 
...
<div class='crugepanel user-assignments-detail'>
	...
	<div id='revocarSeleccion' class='boton'>
		...
		<img title="Revocar" class="iconCore iconhelp deny-icon" style="cursor: pointer;">
	</div>
	<?php 
	...
	<div id='asignarSeleccion' class='boton'>
		<?php echo CrugeTranslator::t("asignar seleccion");?>
		<img title="Asignar" class="iconCore iconhelp grant2-icon" style="cursor: pointer;">
	</div>
	<?php 
		$this->widget(Yii::app()->user->ui->CGridViewClass, array(
			'id'=>'_lista2',
