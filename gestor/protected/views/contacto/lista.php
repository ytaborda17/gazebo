...
$('.search-form form').submit(function(){
	$('#contacto-grid').yiiGridView('editar', {
		data: $(this).serialize()
	});
	return false;
});
...
$this->widget('booster.widgets.TbGridView', array(
	...
	'columns'=>array(
		...
		/*'empresa_id' => array(
			'name'   => 'empresa_id',
			'type'   => 'raw',
			'value'  => array($model,'getEmpresa'), 
			'filter' => CHtml::listData(Empresa::model()->findAll(array('order'=>'nombre')), 'id', 'nombre'),
			),*/
		'tipo_id' => array(
			'name'   => 'tipo_id',
			'type'   => 'raw',
			'value'  => array($model,'getContactoTipo'), 
			'filter' => CHtml::listData(ContactoTipo::model()->findAll(array('order'=>'nombre')), 'id', 'nombre'),
			),
		/*'red_id' => array(
			'name'   => 'red_id',
			'type'   => 'raw',
			'value'  => array($model,'getRed'), 
			'filter' => CHtml::listData(RedSocial::model()->findAll(array('order'=>'nombre')), 'id', 'nombre'),
			),*/
		'valor',
		'estatus' => array(
			'name' => 'estatus',
