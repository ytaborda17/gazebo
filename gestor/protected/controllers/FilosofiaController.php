...
class FilosofiaController extends Controller
{
	public function beforeRender()
	{
		...
		$this->pageTitle = "Filosofia - " . Yii::app()->name;
	...
	public function actionNuevo()
	{
		...
		if(isset($_POST['Filosofia']))
		{
			$model->attributes=$_POST['Filosofia'];
			$model->estatus = (isset($_POST['Filosofia']['estatus']) ? 1 : 0);
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('Filosofia');
	...
	public function actionLista()
	{
		...
		$model=new Filosofia('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Filosofia']))
			$model->attributes=$_GET['Filosofia'];
	 ...
	 * @return Filosofia the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Filosofia::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Filosofia $model the model to be validated
	 */
