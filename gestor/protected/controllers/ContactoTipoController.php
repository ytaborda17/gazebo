...
class ContactoTipoController extends Controller
{
	public function beforeRender()
	{
		...
		$this->pageTitle = "ContactoTipo - " . Yii::app()->name;
	...
	{
		$model=new ContactoTipo;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['ContactoTipo']))
		{
			$model->attributes=$_POST['ContactoTipo'];
			$model->estatus = (isset($_POST['ContactoTipo']['estatus']) ? 1 : 0);
	...
	{
		$dataProvider=new CActiveDataProvider('ContactoTipo');
	...
	public function actionLista()
	{
		...
		$model=new ContactoTipo('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ContactoTipo']))
			$model->attributes=$_GET['ContactoTipo'];
	 ...
	 * @return ContactoTipo the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=ContactoTipo::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ContactoTipo $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='contacto-tipo-form')
		{
