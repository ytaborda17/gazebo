...
class RedSocialController extends Controller
{
	public function beforeRender()
	{
		...
		$this->pageTitle = "RedSocial - " . Yii::app()->name;
	...
	public function actionNuevo()
	{
		...
		{
			$model->attributes=$_POST['RedSocial'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('RedSocial');
	...
	public function actionLista()
	{
		...
		$model=new RedSocial('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['RedSocial']))
			$model->attributes=$_GET['RedSocial'];
	 ...
	 * @param RedSocial $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='red-social-form')
		{
